...
A `Exec()` function is also provided as utilty, but is just a simple wrapper to use for queries generated by this package as there is no result data to be scanned.
